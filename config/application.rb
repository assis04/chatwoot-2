...
# Fork Valcenter: carregado cedo pra podermos consultar ChatwootApp.enterprise?
# ainda dentro do config/application.rb (guarda do autoload do overlay enterprise).
