# Fork Valcenter: reimplementação base (Community) do CRUD de funções personalizadas.
# Antes vinha do overlay enterprise; agora é código nosso, sem depender do EE.
