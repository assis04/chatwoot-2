...
ActiveRecord::Schema[7.1].define(version: 2026_07_31_000001) do
  ...
  create_table "conversation_read_states", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_conversation_read_states_on_account_id"
    t.index ["conversation_id", "user_id"], name: "index_conv_read_states_on_conversation_and_user", unique: true
